...
This project is no longer actively maintained by its original author, Athlas - and that's by design. **Feel free to take it over and do whatever you want with it**: fork it, rename it, ship it, sell it, turn it into something completely different. No permission needed (the MIT license already covers you), no attribution expected.

If you build something cool with it, Athlas would love to hear about it - say hi on X: [@CarlAtAthlas](https://x.com/CarlAtAthlas) or [@athlasio](https://x.com/athlasio).
