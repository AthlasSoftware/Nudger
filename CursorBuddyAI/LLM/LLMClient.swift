...
class LLMClient {
    ...
    func proposeSuggestion(context: Context, tone: Tone) async throws -> Suggestion? {
        ...
        - Don't assume abbreviations (e.g., "MC" could be motorcykel, Minecraft, emcee, etc.)
        - Look for context clues in the title (Swedish words, gaming terms, tech terms, etc.)
